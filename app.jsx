...
export default function EchoGame() {
    ...
    async function handleGuess() {
        ...
        setWrongGuesses(w => {
            ...
            if (idx !== -1) updated[idx] = { text: currentGuess, warmth: result ? result.score : null, hint: result ? result.hint : null };
            return updated;
        });
                ...
                {phase === "playing" && puzzle && (
                    <div>
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "28px" }}>
                            <div>
                                <span style={{ fontSize: "22px", fontWeight: 900, letterSpacing: "-0.03em" }}>ECHO</span>
                                        ...
                                        <div key={i} style={{
                                            ...
                                            {w.warmth === null ? (
                                                ...
                                                <div style={{ textAlign: "right" }}>
                                                    ...
                                                    {w.hint && <div style={{ fontSize: "9px", color: "#555", marginTop: "3px", fontStyle: "italic" }}>{w.hint}</div>}
                                                </div>
                                            )}
                                        </div>
                                    );
                        ...
                        <button onClick={() => setPhase("intro")} style={{
                            marginTop: "28px", background: "transparent", border: "none",
